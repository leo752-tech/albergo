...
<section id="booking-form" class="container section-padding">
    ...
    <form action="{if $idOffer !== null}/albergoPulito/public/Booking/getAvailableRoomsBySpecialOffer/{$idOffer}{else}/albergoPulito/public/Booking/getAvailableRooms{/if}" method="POST" class="form-grid">
