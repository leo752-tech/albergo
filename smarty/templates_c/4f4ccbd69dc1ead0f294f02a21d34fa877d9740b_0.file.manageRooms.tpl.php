...
?>
 ...
 €</td> <td><?php echo $_smarty_tpl->tpl_vars['room']->value->getType();?>
                    ...
                    <a href="/~momok/Admin/updateRoom/<?php echo $_smarty_tpl->tpl_vars['room']->value->getId();?>
" class="btn btn-sm btn-primary">Modifica</a>
                    <a href="/~momok/Admin/deleteRoom/<?php echo $_smarty_tpl->tpl_vars['room']->value->getId();?>
