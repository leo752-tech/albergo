...
class FRegisteredUser {
    ...
    private static $key = "registeredUserId";

    private static $class = "FRegisteredUser";
    
    private static $table = "registereduser";
    
    private static $values = "(NULL,:userId,:email,:password,:firstName,:lastName,:birthDate,:birthCity)";
    ...
    public static function createObject($queryRes){
        $user = new ERegisteredUser(null, $queryRes["userId"], $queryRes["email"], $queryRes["password"], $queryRes["firstName"], $queryRes["lastName"], $queryRes["birthDate"], $queryRes["birthCity"]);
        if (isset($queryRes["registeredUserId"])) {
            $user->setId($queryRes["registeredUserId"]);
